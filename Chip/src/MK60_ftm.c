...
/*
 * @说明 ； 山外的库中没有K60FN的FTM3模块，所以加上FTM3模块
 *
 * @时间 ： 2015.12.16
 *
 * @修改 ： 胡文松
...
static void FTM_port_mux(FTMn_e ftmn, FTM_CHn_e ch)
{
    ...
    case FTM3:
        ...
        case FTM_CH0:
            if(FTM3_CH0 == PTD0)
            {
                port_init(FTM3_CH0, ALT4);
            }
            else if(FTM3_CH0 == PTE5)
            {
                port_init(FTM3_CH0, ALT6);
            }
            else
            {
                ASSERT(0);                      //设置管脚有误？
        ...
        case FTM_CH1:
            if(FTM3_CH1 == PTD1)
            {
                port_init(FTM3_CH1, ALT4);
            }
            else if(FTM3_CH1 == PTE6)
            {
                port_init(FTM3_CH1, ALT6);
            }
            else
            {
                ASSERT(0);                      //设置管脚有误？
        ...
        case FTM_CH2:
            if(FTM3_CH2 == PTD2)
            {
                port_init(FTM3_CH2, ALT4);
            }
            else if(FTM3_CH2 == PTE7)
            {
                port_init(FTM3_CH2, ALT6);
            }
            else
            {
                ASSERT(0);                      //设置管脚有误？
        ...
        case FTM_CH3:
            if(FTM3_CH3 == PTD3)
            {
                port_init(FTM3_CH3, ALT4);
            }
            else if(FTM3_CH3 == PTE8)
            {
                port_init(FTM3_CH3, ALT6);
            }
            else
            {
                ASSERT(0);                      //设置管脚有误？
        ...
        case FTM_CH4:
            if(FTM3_CH4 == PTC8)
            {
                port_init(FTM3_CH4, ALT3);
            }
            else if(FTM3_CH4 == PTE9)
            {
                port_init(FTM3_CH4, ALT6);
            }
            else
            {
                ASSERT(0);                      //设置管脚有误？
        ...
        case FTM_CH5:
            if(FTM3_CH5 == PTC9)
            {
                port_init(FTM3_CH5, ALT3);
            }
            else if(FTM3_CH5 == PTE10)
            {
                port_init(FTM3_CH5, ALT6);
            }
            else
            {
                ASSERT(0);                      //设置管脚有误？
        ...
        case FTM_CH6:
            if(FTM3_CH6 == PTC10)
            {
                port_init(FTM3_CH6, ALT3);
            }
            else if(FTM3_CH6 == PTE11)
            {
                port_init(FTM3_CH6, ALT6);
            }
            else
            {
                ASSERT(0);                      //设置管脚有误？
        ...
        case FTM_CH7:
            if(FTM3_CH7 == PTC11)
            {
                port_init(FTM3_CH7, ALT3);
            }
            else if(FTM3_CH7 == PTE12)
            {
                port_init(FTM3_CH7, ALT6);
            }
            else
            {
                ASSERT(0);                      //设置管脚有误？
...
void FTM_PWM_init(FTMn_e ftmn, FTM_CHn_e ch, uint32 freq, uint32 duty)
{
    ...
    ASSERT( (ftmn == FTM3) || (ftmn == FTM0) || ( (ftmn == FTM1 || ftmn == FTM2 ) && (ch <= FTM_CH1))   );  //检查传递进来的通道是否正确
